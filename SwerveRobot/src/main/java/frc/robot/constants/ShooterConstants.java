...
public class ShooterConstants {
    ...
    public static final double SHOOTER_IDLE_VELOCITY = 1 * 2048; // Should be just enought to eject the ball from the robot when the hood is all the way down.
    ...
    public static final double ROTS_PER_MIN_MAX = 2;
