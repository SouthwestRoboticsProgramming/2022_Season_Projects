...
public class ShooterConstants {
    ...
    public static final double INDEX_SPEED = 0.15;
    public static final int INDEX_TIME = 50 * 3; // 50 * seconds

    /* Hardware */
    public static final int FLYWHEEL_MOTOR_ID = 50943; //FIXME
    public static final int HOOD_MOTOR_ID = 432432; //FIXME
